...
const languageUrls = {
    'en': 'contact-us.html', // Replace with your actual URL for English
    'bg': 'contact-us.html'  // Replace with your actual URL for Bulgarian
};
...
document.getElementById("start-chat-button").addEventListener("click", function() {
    // Toggle the chat box as if the sticky-circle was clicked
